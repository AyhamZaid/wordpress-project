...
if ( ! function_exists( 'ecommerce_solution_credit' ) ) {
	function ecommerce_solution_credit(){
		echo "<a href=".esc_url(ECOMMERCE_SOLUTION_CREDIT)." target='_blank' alt='".esc_html__('Buywptemplate','ecommerce-solution')."''>".esc_html__('Buywptemplate','ecommerce-solution')."</a>";
	}
}
