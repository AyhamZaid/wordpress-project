...
<?php else : ?>
	...
	<div class="read-moresec">
		<a href="<?php echo esc_url( home_url() ); ?>" alt="<?php esc_html_e( 'Back to Home Page', 'ecommerce-solution' ); ?>" class="button"><?php esc_html_e( 'Back to Home Page', 'ecommerce-solution' ); ?><span class="screen-reader-text"><?php esc_html_e( 'Back to Home Page', 'ecommerce-solution' ); ?></span></a>
	</div>
<?php endif; ?>